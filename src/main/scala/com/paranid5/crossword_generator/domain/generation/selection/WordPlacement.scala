...
import com.paranid5.crossword_generator.data.generation.population.Layout.{HORIZONTAL, VERTICAL}
import com.paranid5.crossword_generator.data.generation.population.{Layout, Table, WordState}
import com.paranid5.crossword_generator.domain.generation.selection.filters.*
