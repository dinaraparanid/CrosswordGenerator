package com.paranid5.crossword_generator.domain.generation.crossover

import com.paranid5.crossword_generator.data.generation.population.{Coords, CoordsWithLayout, Layout, Table, WordState}
import com.paranid5.crossword_generator.domain.generation.selection.{canPutWordHorizontal, canPutWordVertical}
